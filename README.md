<h1 align="center">react-native-calendar-line</h1>
<div align="center">
  <strong>Calendar Component for React Native</strong>
</div>
<br>
<div align="center">
  <a href="https://img.shields.io/badge/platforms-android%20|%20ios-blue.svg">
    <img src="https://img.shields.io/badge/platforms-android%20|%20ios-blue.svg" alt="platforms" />
  </a>
  <a href="https://npmjs.org/package/react-native-calendar-line">
    <img src="https://img.shields.io/npm/v/react-native-calendar-line.svg?style=flat-square" alt="npm package version" />
  </a>
  <a href="https://github.com/FelipeBattistotti/react-native-calendar-line/blob/master/LICENSE.md">
    <img src="https://img.shields.io/npm/l/react-native-calendar-line.svg?style=flat-square" alt="project license" />
  </a>
</div>
<br>
...
```sh
$ npm install react-native-calendar-line
# OR
$ yarn add react-native-calendar-line
```
...
| Prop                           | Description                                                                                                                                                                                                                                                                              | Type   | Default    |
| ------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------ | -------------- | ---------- |
| **`style`**                    | Style for the top level CalendarLine component.                                                                                                 | Any            |
...
| Prop                 | Description                                                                                                                                                                             | Type | Default |
| -------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---- | ------- |
| **`dayComponent`**       | User-defined component for the Days. All day-related props are passed to the custom component. | Any  |
...
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![alt text](https://user-images.githubusercontent.com/6295083/81627798-96237280-93c4-11ea-998f-53f7ee07caba.gif "react-native-calendar-line parallel animation demo") | ![alt text](https://user-images.githubusercontent.com/6295083/81627797-96237280-93c4-11ea-874d-1f23fe6ba487.gif "react-native-calendar-line parallel animation demo") |
...
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![alt text](https://user-images.githubusercontent.com/6295083/81627793-94f24580-93c4-11ea-9726-89a56b2c4d49.gif "react-native-calendar-line border animation demo") | ![alt text](https://user-images.githubusercontent.com/6295083/81627791-93c11880-93c4-11ea-8a1b-e5fb5848d2a7.gif "react-native-calendar-line simple demo") |
...
This prop is used for adding localization to react-native-calendar-line component. The localization rules are the same as moments and can be found in [moments documentation](http://momentjs.com/docs/#/i18n/)
...
<ul>
<li>OnePlus devices use OnePlus Slate font by default which causes text being cut off in the date number in react-native-calendar-line. To overcome this change the default font of the device or use a specific font throughout your app.</li>
</ul>
